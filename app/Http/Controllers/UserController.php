...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('users.index', compact('users')); // Passa gli utenti alla vista
    }
    ...
    {
        return view('users.create'); // Mostra la vista per la creazione
    }
    ...
    {
        return view('users.edit', compact('user')); // Mostra la vista per la modifica
    }
